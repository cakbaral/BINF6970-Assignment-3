...
#PCA
#In the last assignment we were told we needed to scale but i dont know if its necessary here since all our values are 0, 1 and 2
PCA <- prcomp(Cleaned_AFR_DF[ ,-(1:4)], center = T)
